...
fun ModalBottomSheetLayoutDemo(){
    ...
    ModalBottomSheetLayout(sheetState = modalState,sheetContent = {
        Text(modifier = Modifier.padding(start = 8.dp,top = 8.dp),text = "Title",fontWeight = FontWeight.Bold,style = typography.h5)
        Text(modifier = Modifier.padding(start = 8.dp,top = 8.dp),text = "Content example right here :)",style = typography.body1)
